...
## Project Structure
    ...
    ├── square_waterfall_de_59676  # Django project configurations
...
1. Clone this repo and `cd square_waterfall_de_59676`
...
2. Clone this repo and `cd square_waterfall_de_59676`
